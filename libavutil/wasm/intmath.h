...
#define av_clipd av_clipd_wasm
static av_always_inline av_const double av_clipd_wasm(double a, double amin, double amax) {
...
#define av_clipf av_clipf_wasm
static av_always_inline av_const float av_clipf_wasm(float a, float amin, float amax) {
