...
static void ff_butterflies_fixed_wasm(int *v1, int *v2, int len) {
...
void ff_fixed_dsp_init_wasm(AVFixedDSPContext *fdsp)
{

    #if HAVE_SIMD128
        fdsp->butterflies_fixed = ff_butterflies_fixed_wasm;
    #endif
}
